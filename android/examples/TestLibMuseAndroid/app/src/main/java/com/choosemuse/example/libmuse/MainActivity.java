...
public class MainActivity extends Activity implements OnClickListener {
    ...
    Drawable[] myImages = new Drawable[3];
    int i = 0;
    ...
    List<Double> betaWaves = new ArrayList<Double>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation.addFrame(getResources().getDrawable(R.drawable.slide1), 10000);
        animation.addFrame(getResources().getDrawable(R.drawable.slide2), 10000);
        animation.addFrame(getResources().getDrawable(R.drawable.slide3), 10000);
        ...
        dataListener = new DataListener(weakActivity, betaWaves);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.refresh) {
           ...
           /* for (int i = 0; i < betaWaves.size(); i++) {
                Log.d("RESULTS: ", betaWaves.get(i) + "");
            }*/

           //FIND THE AVERAGE BETAWAVE VALUE FOR QUESTION
            ...
            while (totalCounter < 3) {
                ...
                for (int index = 0; index < betaWaves.size() / 3; index++) {
                    total = total + betaWaves.get(counter);
                    counter++;
                }

                averages[totalCounter] = (total / betaWaves.size());
            ...
            Log.d("TEST: ", "TEST");
            Log.d("FIRST: ", averages[0] + "");
            Log.d("SECOND: ", averages[1] + "");
            Log.d("THIRD: ", averages[2] + "");
     ...
     */
    public void receiveMuseDataPacket(final MuseDataPacket p, final Muse muse, List<Double> values) {
        ...
        switch (p.packetType()) {
            ...
            case BETA_ABSOLUTE:
                ...
                getEegChannelValues(betaBuffer,p, values);
                betaStale = true;
                break;
            case BATTERY:
            case DRL_REF:
    ...
    private void getEegChannelValues(double[] buffer, MuseDataPacket p, List<Double> values) {
    ...
    private void animateImages(AnimationDrawable animation) {
    ...
    private void updateBeta() {
        ...
        elem1.setText(String.format("%6.2f", betaBuffer[0]));
        TextView elem2 = (TextView)findViewById(R.id.elem2);
        elem2.setText(String.format("%6.2f", betaBuffer[1]));
        TextView elem3 = (TextView)findViewById(R.id.elem3);
        elem3.setText(String.format("%6.2f", betaBuffer[2]));
    ...
    class DataListener extends MuseDataListener {
        ...
        List<Double> betaWaves;
        DataListener(final WeakReference<MainActivity> activityRef, List<Double> values) {
            this.activityRef = activityRef;
            betaWaves = values;
        }


        public void receiveMuseDataPacket2(final MuseDataPacket p, final Muse muse, List<Double> values) {
            activityRef.get().receiveMuseDataPacket(p, muse, values);
        }

        @Override
        public void receiveMuseDataPacket(final MuseDataPacket p, final Muse muse) {
            receiveMuseDataPacket2(p, muse, this.betaWaves);
        }
